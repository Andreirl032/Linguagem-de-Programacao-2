...
public class JanelaShowRestaurante extends JFrame implements ActionListener{
	// Atributos:
		// Define:
	...
	// Construtor:
		public JanelaShowRestaurante(Attraction a){
	...
	// Metodos Adicionais:
		...
		public void actionPerformed(ActionEvent event){
			if(event.getSource() == excluir){
			 	if(salvar.excRestaurante(restaurante)){
	       			System.out.printf("Restaurante %s excluida!\n", restaurante.getName());
		       	}else{
		       		System.out.printf("ERR -> Não foi Possivel excluir o Restaurante %s!\n", restaurante.getName());
		       	}
