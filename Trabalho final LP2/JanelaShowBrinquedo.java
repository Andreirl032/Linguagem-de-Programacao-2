...
public class JanelaShowBrinquedo extends JFrame implements ActionListener{
	// Atributos:
		// Define:
	...
	// Construtor:
		public JanelaShowBrinquedo(Brinquedo b){
	...
	// Metodos Adicionais:
		...
		public void actionPerformed(ActionEvent event){
			if(event.getSource() == excluir){
		       	if(salvar.excBrinquedo(brinquedo)){
	       			System.out.printf("Brinquedo %s excluida!\n", brinquedo.getName());
		       	}else{
		       		System.out.printf("ERR -> Não foi Possivel excluir o Brinquedo %s!\n", brinquedo.getName());
		       	}
